<div class="container">
    <br><h2 class="postname"><p >GENERAL INFORMATION</p></h2>
    <hr>
    <div class="account-info clearfix">
        <h3 class="posttitle">Account Information</h3><hr>
        ...
        <h3 class="posttitle">Following</h3><hr>
        <div class="manga-follower">
            <?php 
                $row = mysqli_fetch_assoc($data["Manga"])
            ?>
